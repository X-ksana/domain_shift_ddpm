...
def get_data(args):
  # Set seed for reproducibility
    ...
    print("Starting...with seed 42")

# Define the center crop size
    print(f"Starting...with crop size:{args.img_size}")
...
# Define the transformations
   ...
   #     T.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
    ...
    train_dataset = NiftiDataset(root_dir='/nobackup/scxcw/dataset_cmr/MCMV_Train', transform=train_transform)
    val_dataset = NiftiDataset(root_dir='/nobackup/scxcw/dataset_cmr/MCMV_Valid', transform=val_transform)

    print("Done!")
    print("Nifti processing and dataset loading complete...")
 


# Print the sizes of the training and testing sets
    print(f"Training set size: {len(train_dataset)}")
    print(f"Testing set size: {len(val_dataset)}")
